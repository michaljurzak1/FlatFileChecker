...
namespace FlatFileCheck.Tests
{
    ...
    {
        static string[] skrotyPodatnikowCzynnych = new string[]
            {
        ...
        static string[] skrotyPodatnikowZwolnionych = new string[]
        {
        ...
        static string[] maski = new string[]
        {
        ...
        static IConnection _connection = new SqliteDB(false, DbPath, DbName, true);
        static DownloadDataSourceFactory downloadFactory = new DownloadDataSourceFactory(_connection);
        

        private const string generationDate = "20240725";
        private const string nTransformations = "5000";

        static Dictionary<string, string[]> tableDataPairs = new Dictionary<string, string[]>
                {
